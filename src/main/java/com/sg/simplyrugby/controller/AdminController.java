...
import com.sg.simplyrugby.model.SysNotice;
import com.sg.simplyrugby.model.SysUser;
import com.sg.simplyrugby.satoken.SaTokenUtil;
import com.sg.simplyrugby.service.SysUserService;
import com.sg.simplyrugby.util.ServletUtils;
...
public class AdminController extends BaseController {
    ...
    @Autowired
    private SysUserService tsysUserDao;
    ...
    public String index(HttpServletRequest request) {
        ...
        SysNotice sysNotice = new SysNotice("aaa","黑乎乎","<p>顶顶顶顶顶顶顶顶顶顶<img src=\"http://img.baidu.com/hi/jx2/j_0014.gif\"/></p>",1,"","",new Date());
    ...
    @PostMapping("/login")
    @ResponseBody
    public AjaxResult login(SysUser user, String captcha, RedirectAttributes redirectAttributes, boolean rememberMe,
        ...
        if (yz) {
            ...
            // 是否验证通过
            if (!StpUtil.isLogin()) {
                SysUser queryUser = tsysUserDao.queryUserName(userName);
                // 各种校验
                if (queryUser == null) {
